...
const HIGHLIGHT_ICONS = [
  ...
  >
    ...
    <path
      ...
      fill="currentColor"
    ></path>
    <path d="M7 4C7.55228 4 8 3.55228 8 3C8 2.44772 7.55228 2 7 2C6.44772 2 6 2.44772 6 3C6 3.55228 6.44772 4 7 4Z" fill="currentColor"></path>
    <path
    ...
    <path d="M5 8C5.55228 8 6 7.55228 6 7C6 6.44772 5.55228 6 5 6C4.44772 6 4 6.44772 4 7C4 7.55228 4.44772 8 5 8Z" fill="currentColor"></path>
    <path
      d="M13 10C13.5523 10 14 9.55228 14 9C14 8.44772 13.5523 8 13 8C12.4477 8 12 8.44772 12 9C12 9.55228 12.4477 10 13 10Z"
      fill="currentColor"
    ></path>
    <path d="M9 10C9.55228 10 10 9.55228 10 9C10 8.44772 9.55228 8 9 8C8.44772 8 8 8.44772 8 9C8 9.55228 8.44772 10 9 10Z" fill="currentColor"></path>
    <path d="M5 10C5.55228 10 6 9.55228 6 9C6 8.44772 5.55228 8 5 8C4.44772 8 4 8.44772 4 9C4 9.55228 4.44772 10 5 10Z" fill="currentColor"></path>
    <path
  ...
  >
    ...
    <path
      d="M11 10C11 9.44772 10.5523 9 10 9C9.44772 9 9 9.44772 9 10C9 10.5523 9.44772 11 10 11C10.5523 11 11 10.5523 11 10Z"
      fill="currentColor"
    ></path>
    <path
      d="M11 2C11.5523 2 12 1.55228 12 1C12 0.447715 11.5523 2.41411e-08 11 0C10.4477 -2.41411e-08 10 0.447715 10 1C10 1.55228 10.4477 2 11 2Z"
    ...
    ></path>
    <path
      d="M5 2C4.44772 2 4 1.55228 4 1C4 0.447715 4.44772 2.41411e-08 5 0C5.55228 -2.41411e-08 6 0.447715 6 1C6 1.55228 5.55228 2 5 2Z"
      fill="currentColor"
    ></path>
    <path
      d="M13 2C13.5523 2 14 1.55228 14 1C14 0.447715 13.5523 2.41411e-08 13 0C12.4477 -2.41411e-08 12 0.447715 12 1C12 1.55228 12.4477 2 13 2Z"
      fill="currentColor"
    ></path>
    <path
      d="M3 2C2.44772 2 2 1.55228 2 1C2 0.447715 2.44772 2.41411e-08 3 0C3.55228 -2.41411e-08 4 0.447715 4 1C4 1.55228 3.55228 2 3 2Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M1 4C0.447715 4 2.41411e-08 3.55228 0 3C-2.41411e-08 2.44772 0.447715 2 1 2C1.55228 2 2 2.44772 2 3C2 3.55228 1.55228 4 1 4Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M1 6C0.447715 6 2.41411e-08 5.55228 0 5C-2.41411e-08 4.44772 0.447715 4 1 4C1.55228 4 2 4.44772 2 5C2 5.55228 1.55228 6 1 6Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M1 8C0.447715 8 2.41411e-08 7.55228 0 7C-2.41411e-08 6.44772 0.447715 6 1 6C1.55228 6 2 6.44772 2 7C2 7.55228 1.55228 8 1 8Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M1 10C0.447715 10 2.41411e-08 9.55228 0 9C-2.41411e-08 8.44772 0.447715 8 1 8C1.55228 8 2 8.44772 2 9C2 9.55228 1.55228 10 1 10Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M1 14C0.447715 14 2.41411e-08 13.5523 0 13C-2.41411e-08 12.4477 0.447715 12 1 12C1.55228 12 2 12.4477 2 13C2 13.5523 1.55228 14 1 14Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M1 12C0.447715 12 2.41411e-08 11.5523 0 11C-2.41411e-08 10.4477 0.447715 10 1 10C1.55228 10 2 10.4477 2 11C2 11.5523 1.55228 12 1 12Z"
      fill="currentColor"
    ></path>
    <path
      d="M11 16C11.5523 16 12 15.5523 12 15C12 14.4477 11.5523 14 11 14C10.4477 14 10 14.4477 10 15C10 15.5523 10.4477 16 11 16Z"
    ...
    ></path>
    <path
      d="M5 16C4.44772 16 4 15.5523 4 15C4 14.4477 4.44772 14 5 14C5.55228 14 6 14.4477 6 15C6 15.5523 5.55228 16 5 16Z"
      fill="currentColor"
    ></path>
    <path
    ...
    ></path>
    <path
      d="M3 16C2.44772 16 2 15.5523 2 15C2 14.4477 2.44772 14 3 14C3.55228 14 4 14.4477 4 15C4 15.5523 3.55228 16 3 16Z"
      fill="currentColor"
    ></path>
    ...
    >
        ...
        <div className="overflow-hidden">
          <div className="flex items-center justify-between pt-1 pb-1 gap-2">
            <div className="flex flex-col gap-0.5 sm:gap-1 min-w-0 flex-1">
              <h2 className="dot-heading text-sm sm:text-base tracking-wider text-neutral-900 lowercase truncate">{product.name}</h2>
              {selectedVariant?.highlights && selectedVariant.highlights.filter(Boolean).length > 0 && (
                <ul className="space-y-0 sm:space-y-0.5 mt-0.5 min-w-0">
                  {selectedVariant.highlights.filter(Boolean).map((hl, i) => (
                    <li key={i} className="flex items-center gap-2 sm:gap-3 mb-2 text-[10px] sm:text-xs text-black uppercase tracking-wide min-w-0">
                      <span className="shrink-0 w-3 h-3 sm:w-4 sm:h-4 flex items-center justify-center [&>svg]:w-full [&>svg]:h-full">
                        {HIGHLIGHT_ICONS[i] || null}
                      </span>
                      <span className="truncate pb-0 pt-1" title={hl} style={{ fontFamily: "'LatteraMonoLL', 'letteraRegular', monospace" }}>
                        {hl}
                      </span>
                    </li>
                  ))}
              ...
              <div className="text-right">
                ...
                Number(activePrices.price) > Number(activePrices.salePrice) ? (
                  <div className="flex flex-col items-end">
                    <span className="line-through text-neutral-400 text-[9px] sm:text-xs font-mono">{formatPrice(activePrices.price)}</span>
                    <span className="font-bold text-neutral-900 text-[11px] sm:text-base font-mono">{formatPrice(activePrices.salePrice)}</span>
                  </div>
                ) : (
                  <span className="font-bold text-neutral-900 text-[11px] sm:text-base font-mono">{formatPrice(activeDisplayPrice)}</span>
                )}
              </div>
            </div>
          </div>
          ...
          {displayColors.map((colorName) => {
            ...
            return (
              <button
                ...
                title={colorName}
                className={`group relative h-5 w-5 sm:h-7 sm:w-7 rounded-full transition-all duration-200 cursor-pointer flex items-center justify-center  ${
                  isSelected ? "ring-2 ring-[#D71921] ring-offset-2 ring-offset-white scale-110" : "hover:scale-105 opacity-80 hover:opacity-100"
                }`}
              >
                <span className="h-full w-full rounded-full" style={{ backgroundColor: hexColor }} />
              </button>
            );
          })}
        </div>
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          className={`w-1/2 font-lattera-mono sm:text-xs text-[9px] px-2 font-medium uppercase tracking-widest py-3 rounded-lg flex items-center justify-center gap-2 h-auto border-none ${
        ...
        >
          <span style={{ fontFamily: "'LatteraMonoLL', 'letteraRegular', monospace" }} className="flex items-center gap-1">
            {isCurrentCapacityComingSoon ? (
              <span className="md:font-bold font-medium text-white tracking-widest">COMING SOON</span>
            ) : (
