...
const faqs = [
  {
    ...
    answer: "Yes. Nothing Pakistan is operated by NOTHING OFFICIAL (SMC-PRIVATE) LIMITED, an SECP registered Pakistani company with CUIN 0337422. This verification page is published so customers can confidently confirm the registered business identity behind the website before placing an order."
  },
  {
    question: "What is the legal company name behind Nothing Pakistan?",
    answer: "The official registered company name is NOTHING OFFICIAL (SMC-PRIVATE) LIMITED. Nothing Pakistan is the customer-facing storefront for the company, used for product discovery, online shopping, customer support, delivery updates, and after-sales communication in Pakistan."
  },
  {
    question: "Is Nothing Pakistan the official registered Nothing business in Pakistan?",
    answer: "Nothing Pakistan is operated by NOTHING OFFICIAL (SMC-PRIVATE) LIMITED, whose registered company name includes Nothing Official and whose SECP registration is published openly on this website. Customers can use this page to verify the company name, CUIN, certificate, and business information."
  },
  {
    question: "How can customers verify the company registration?",
    answer: "Customers can verify the company by checking the legal name NOTHING OFFICIAL (SMC-PRIVATE) LIMITED, CUIN 0337422, incorporation date, and SECP certificate linked on this page. The same verification link is also available from the website footer for quick access."
  },
  {
    question: "Why should customers buy from Nothing Pakistan?",
    answer: "Customers choose Nothing Pakistan because the store shows a clear Pakistani business identity, product information, support channels, delivery expectations, and company verification. The goal is to make Nothing and CMF shopping in Pakistan more transparent and easier to trust."
  },
  {
    question: "Who is the CEO of Nothing Pakistan?",
    answer: "Usman Afzal is the CEO of Nothing Pakistan. He leads the company focus on verified business identity, clear customer support, transparent product listings, and a reliable shopping experience for customers across Pakistan."
  },
  {
    question: "Does Nothing Pakistan provide support after purchase?",
    answer: "Yes. Nothing Pakistan provides customer support through the website, WhatsApp, phone, and email channels listed on the contact page. Customers can contact the team for order updates, product questions, delivery details, and return or replacement guidance."
  },
  {
    question: "Can customers view the SECP certificate?",
    answer: "Yes. The SECP certificate is available from this Company Verification page through the View SECP Certificate button. Publishing the certificate helps customers confirm the registered company information without needing to search across multiple pages."
  },
  {
    question: "Does Nothing Pakistan deliver across Pakistan?",
    answer: "Yes. Nothing Pakistan serves customers across Pakistan, subject to product availability, delivery coverage, and order confirmation. Delivery details are shared during checkout or support communication so customers know what to expect before payment and dispatch."
  },
  {
    question: "How does company verification help customers shop safely?",
    answer: "Company verification helps customers know the registered Pakistani business behind the website, the legal company name, and the support channels before ordering. It adds accountability and makes the buying process clearer from product selection to delivery and support."
  }
];
    ...
    <div className="min-h-screen bg-[#f4f4f6] text-[#111] font-sans pt-20">
      ...
      >
        <div className="absolute left-5 right-5 top-[188px] md:left-6 md:right-6 md:top-[210px] lg:left-[calc(50%-470px)] lg:top-[220px] w-full max-w-[min(500px,calc(100vw-40px))] z-10">
          ...
          <p className="mt-6 font-sans text-base leading-[1.55] text-black/60">
            Nothing Pakistan is operated by NOTHING OFFICIAL (SMC-PRIVATE) LIMITED. The company is registered with the Securities and Exchange Commission of Pakistan under CUIN 0337422.
          </p>
        </div>
      </section>
      ...
      <div className="mx-auto w-full max-w-[940px] px-6 py-[88px] md:px-6 md:py-[112px] lg:px-0 lg:py-[128px] lg:pb-[152px]">
        ...
        <section className="mt-[78px] lg:mt-[104px] bg-[#111] text-white p-6 md:p-[34px]" aria-label="Registered company contact details">
          <p className="font-mono text-xs uppercase tracking-[0.18em] leading-none text-white/56">
            Registered Company
          </p>
          <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-9 gap-y-6 mt-[30px]">
            ...
            <div className="flex flex-col">
              ...
              <dd className="mt-2 font-sans text-base leading-[1.45] text-white/86">
                <a href="tel:+923110066648" className="hover:underline">
                  +923110066648
                </a>
              </dd>
            </div>
          ...
          <div className="mt-6">
            ...
            {faqs.map((faq, i) => (
              <article key={i} className="py-4 md:py-5">
                ...
                {expandedIndex === i && (
                  <p className="mt-4 max-w-[900px] font-sans text-sm leading-7 text-black/68">
                    {faq.answer}
                  </p>
                )}
                <div 
