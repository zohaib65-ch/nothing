...
const jsonLd = [
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Support Centre", item: "https://www.nothingshop.pk/support-centre" },
    ],
  },
  {
    "@context": "https://schema.org",
      ...
      <section className="relative flex items-end justify-center min-h-[520px] md:min-h-[650px] overflow-hidden px-6 pb-10 md:px-8 md:pb-14">
        ...
        <div className="relative z-10 w-full max-w-[760px] text-left">
          ...
          <p className="mt-4 max-w-[500px] text-sm leading-[1.8] text-black/60">
            Learn more about your Nothing Pakistan products, find answers,
            troubleshoot problems, request help and more.
          </p>
          <form
            role="search"
          ...
          <div className="mt-6">
            ...
            {filteredFaqs.map((faq, i) => (
              <article key={i} className="py-4 md:py-5">
                ...
                {expandedIndex === i && (
                  <p className="mt-4 max-w-[900px] text-sm leading-7 text-black/68">
                    {faq.answer}
                  </p>
                )}
                {/* Dot separator */}
        ...
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="mt-8 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <p className="max-w-[560px] font-ntype text-sm leading-[1.7] text-black/60">
              Feel free to send us a message for further support. Our Nothing
              Pakistan team is on-hand to help.
            </p>
            <a
