...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.nothingshop.pk/pages/terms-of-sale" },
};
    ...
    <div className="min-h-screen overflow-x-hidden bg-[#f4f5f8] text-[#111] px-4 pb-16 pt-24 md:pb-24 font-sans">
      <section className="mx-auto grid w-full max-w-screen-2xl gap-6 lg:grid-cols-[300px_1fr]">
        ...
        <aside className="h-fit rounded-2xl border border-black/10 bg-transparent p-5">
          <p className="font-mono text-xs uppercase tracking-[0.10em] text-black/55">
            Nothing Official Pakistan
          </p>
          <h1 className="mt-3 text-3xl font-normal leading-tight tracking-tight text-black">
            Terms of Sale
          </h1>
          ...
          <div className="mt-5 grid gap-2 text-xs leading-6 text-black/65 font-normal">
            <p>
              <span className="text-black/80">Legal:</span>{" "}
              NOTHING OFFICIAL (SMC-PRIVATE) LIMITED
            </p>
            <p>
              <span className="text-black/80">SECP:</span>{" "}
              CUIN 0337422
            </p>
            <p>
              <span className="text-black/80">Effective:</span>{" "}
              May 19, 2026
            </p>
            <p>
              <span className="text-black/80">Updated:</span>{" "}
              May 19, 2026
            </p>
          </div>
        ...
        <article className="rounded-2xl border border-black/10 bg-transparent p-5 md:p-8">
          <div className="mb-7 border-b border-black/15 pb-5">
            ...
            <h2 className="mt-3 text-3xl font-normal tracking-tight text-black md:text-4xl">
              Terms of Sale - NOTHING TECHNOLOGY
            </h2>
          </div>
          <div className="space-y-7">
            <section className="space-y-3">
              <h3 className="text-xl font-normal leading-tight text-black">
                1. Seller Identity
              </h3>
            ...
            <section className="space-y-3">
              <h3 className="text-xl font-normal leading-tight text-black">
                6. Warranty and Product Support
              </h3>
              <div className="space-y-3 text-sm leading-7 text-black/80 md:text-[15px] font-normal">
                <p>
          ...
          <div className="mt-10 rounded-xl border border-black/15 bg-transparent p-4 text-sm leading-7 text-black/75 font-normal">
            This policy is published by Nothing Official Pakistan, operated by NOTHING OFFICIAL (SMC-PRIVATE) LIMITED (CUIN 0337422). For legal, order, return, warranty, or account-specific help, contact support@nothingshop.pk, call {WHATSAPP_NUMBER}, or open the support centre.
          </div>
        </article>
