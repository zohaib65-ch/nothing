...
export function OrdersFilter({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-3 bg-white border border-neutral-200 p-4 rounded-xl items-center shadow-sm">
      {/* Search Input */}
      ...
      <div className="md:col-span-3 relative">
        ...
        <Select value={fulfillmentFilter} onValueChange={(val) => setFulfillmentFilter(val)}>
          <SelectTrigger className="w-full pl-10 text-xs h-10">
            <SelectValue placeholder="ALL FULFILLMENT" />
          </SelectTrigger>
          <SelectContent className="w-full">
            <SelectItem value="all">ALL FULFILLMENT</SelectItem>
            <SelectItem value="ship">DOOR DELIVERY</SelectItem>
